...
public class Test_expenseclear  extends Test_Account_Login{
  ...
  public void view() {
	   ...
	   public void search() throws InterruptedException {
		 ...
		 driver.findElement(By.id("cphpagebody_txt_member")).sendKeys("Ankita");
	   ...
	   public void pay()  {
		   ...
		   driver.findElement(By.id("cphpagebody_Button2")).click();
  }
}
