...
public class Test_member_receipt_cheque extends Test_Account_Login{
	@Test  (priority=1)
	  public void view() throws InterruptedException {
			...
			*/
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@id=\"cphpagebody_ddl_pay_mode\"]/option[3]")).click();
			
			Thread.sleep(2000);
			driver.findElement(By.id("cphpagebody_txt_bank_name")).sendKeys("icici");
			driver.findElement(By.id("cphpagebody_txt_cheque")).sendKeys("icici:7985478");
			
			Thread.sleep(5000);
			driver.findElement(By.id("cphpagebody_txt_cheque_date")).sendKeys("06-25-2019");
